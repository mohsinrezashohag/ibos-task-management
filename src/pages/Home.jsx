...
const Home = () => {
  ...
  // filtering
  let tasksToMap = allTask
  if (statusCondition === 'Inprogress') {
    tasksToMap = allTask.filter((task) => {
      console.log('task.status :', task.status)
      task?.status === 'Inprogress'
    })
  } else if (statusCondition === 'Completed') {
    tasksToMap = allTask.filter((task) => task?.status === 'Completed')
  } else {
    tasksToMap = allTask
  }
    ...
    <>
      ...
      <div className='container mx-auto'>
        <div className='mt-10'>
          ...
          <div className='bg-gray-300 p-6 rounded-md flex justify-between mb-4'>
            <div>
